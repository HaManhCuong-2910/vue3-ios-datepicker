...
async function langDate(type, lang, langObjectCustom, value) {
  if (langObjectCustom) {
    return langObjectCustom[value];
  }
  const modules = import.meta.glob("../lang/**/*.json");
  const path = `../lang/${type}/${lang}.json`;
  const languages = await modules[path]();
  return languages.default[value];
}

export function customRollDate(
  elementAriaControls,
  format,
  title,
  value,
  ...
  !(function (t, i) {
    ...
    !(function (t, i) {
      ...
      `.rolldate-container{font-size:20px;color:#333;text-align:center}.rolldate-container ul{margin:0;padding:0}.rolldate-container li{list-style-type:none}.rolldate-container header{
        ...
        ${
          iconClose
            ? `
            .rolldate-container .rolldate-cancel.icon-close-roll-date{
          --default-url-icon: url("${iconClose}");
        }
          `
            : ""
        }
    ...
    var t,
      Y =
          ...
          t.exports = (function () {
            ...
            function _(t, i, e, o, s, n, r) {
              ...
              return (
                ...
                f < o
                  ? ((f = n ? Math.max(o - n / 4, o - (n / m) * l) : o),
                    (u = d))
                  : s < f &&
                    ((f = n ? Math.min(s + n / 4, s + (n / m) * l) : s),
                    (u = d)),
                {
                ...
                (o
                  ...
                  : ((this.maxScrollX = this.wrapperWidth - this.scrollerWidth),
                    ...
                    this.maxScrollX < 0
                      ...
                      : 1 < this.scale &&
                        ((this.maxScrollX =
                          this.maxScrollX / 2 - this.relativeX),
                    ...
                    this.maxScrollY < 0
                      ...
                      : 1 < this.scale &&
                        ((this.maxScrollY =
                          this.maxScrollY / 2 - this.relativeY),
              ...
              (L.prototype.getComputedPosition = function () {
                ...
                return (
                  (e = this.options.useTransform
                    ? ((i = +(
                        (t = t[x.transform].split(")")[0].split(", "))[12] ||
                        t[4]
                      )),
                      +(t[13] || t[5]))
        ...
        t.exports);
    function handleInfiniteTime(beginYear, endYear, currentYear) {
      if (Number(currentYear) !== beginYear && Number(currentYear) !== endYear)
        return;
      var e = "",
        d = 0,
        start = beginYear,
        finish = endYear;
      if (Number(currentYear) === beginYear) {
        ((start = beginYear - 100), (finish = endYear - 100));
      }
      if (Number(currentYear) === endYear) {
        ((start = beginYear + 100), (finish = endYear + 100));
      }
      for (var p = start; p <= finish; p++) {
        e += '<li class="wheel-item wheel-item-yy '
          .concat(p === Number(currentYear) ? "active" : "", '" data-index=')
          .concat(d, " data-value=")
          .concat(p, ">\n            ")
          .concat(p, "\n          </li>");
        d++;
    ...
    function handleValid(day) {
      ...
      if (validPast !== null && validPast !== void 0 && validPast?.minDate) {
        let timeValid = validPast?.minDate;
        passDay = dayValue.getTime() >= timeValid.getTime();
      }
      ...
      if (
        ...
        let timeValid = validPast?.maxDate;
        passDay = dayValue.getTime() <= timeValid.getTime();
      }

      if (disabledDate && passDay) {
        passDay = !disabledDate(dayValue);
      }
      return passDay;
    }
    function i() {
      var t =
        ...
        e = void 0;
      if ((i.extend(t), t.el)) {
        if (!(e = S(t.el).closest(".vue3-ios-datepicker-container"))) return;
        e.bindRolldate = i;
        i.tap(e, async () => {
          await e.bindRolldate.show();
        });
      }
    }
    return (
      (i.prototype = {
        ...
        createUI: async function createUI() {
          S(this.config.el).focus();
          var newFormatValue = dayjs(
            S(this.config.el).value,
            [this.config.format],
            true,
          ).isValid()
            ? dayjs(S(this.config.el).value, [this.config.format]).toDate()
            : null;
          var timeDefaultCustom = new Date();
          var initValueCustom = this.config.initValue;

          var initH = newFormatValue || initValueCustom || timeDefaultCustom;
          var beginYearInit = handleGetBeginYearAndEndYear(initH).beginYear;
          var endYearInit = handleGetBeginYearAndEndYear(initH).endYear;

          const parts = this.config.format.split(/-|\/|\s|:/g);
          const dateOrder = ["DD", "MM", "YYYY"];
          const timeOrder = ["HH", "mm", "ss"];
          const result = [
            ...dateOrder.filter((p) => parts.includes(p)),
            ...timeOrder.filter((p) => parts.includes(p)),
          ];
          for (
            var n = this,
              t = n.baseData(),
            ...
            if (
              ...
              for (var p = beginYearInit; p <= endYearInit; p++)
                ((e +=
                  '<li class="wheel-item wheel-item-yy ' +
                  (p == h.getFullYear() ? "active" : "") +
                  '" data-index="' +
                  d +
                  '" data-value="' +
                  (p < 10 ? "0" + p : p) +
              ...
              for (var u = 1; u <= 12; u++)
                ((e +=
                  '<li class="wheel-item wheel-item-month ' +
                  (u == h.getMonth() + 1 ? "active" : "") +
                  '" data-index="' +
                  d +
                  '" data-value="' +
                  (u < 10 ? "0" + u : u) +
                  '">' +
                  `${c.month}${await langDate(
                    "month",
                    lang,
                    langObjectCustom,
                    u,
              ...
              for (
                var m = n.getMonthlyDay(h.getFullYear(), h.getMonth() + 1),
                  f = 1;
                f <= m;
                f++
              )
                ((e +=
                  '<li class="wheel-item wheel-item-dd ' +
                  (f == h.getDate() ? "active" : "") +
                  '" data-index="' +
                  d +
                  '" data-value="' +
              ...
              for (var v = 0; v <= 23; v++)
                ((e +=
                  '<li class="wheel-item wheel-item-hh ' +
                  (v == h.getHours() ? "active" : "") +
                  '" data-index="' +
                  d +
                  '" data-value="' +
              ...
              for (var g = 0; g <= 59; g += r.minStep)
                ((e +=
                  '<li class="wheel-item wheel-item-mm ' +
          ...
          var y =
              '<div class="rolldate-mask"></div>\n            <div class="rolldate-panel">\n                <header>\n                    <span class="rolldate-cancel icon-close-roll-date">' +
              "" +
              "</span>\n                    " +
              r.title +
          ...
          ((b.className = "rolldate-container"),
            ...
            (function () {
              ...
              for (var idx = 0; idx < els.length; idx++) {
                ...
                if (["div", "section", "dialog", "header", "aside", "nav", "iframe"].indexOf(tag) !== -1) {
                  var z = window.getComputedStyle(el).zIndex;
                  if (z && !isNaN(z)) {
                    maxZ = Math.max(maxZ, parseInt(z, 10));
                  }
                }
              }
              var maskEl = b.querySelector(".rolldate-mask");
              var panelEl = b.querySelector(".rolldate-panel");
              if (maskEl) maskEl.style.zIndex = maxZ + 1;
              if (panelEl) panelEl.style.zIndex = maxZ + 2;
            })(),
            document.body.appendChild(b),
            (n.scroll = {}));
          var beginYearCustom = JSON.parse(JSON.stringify(beginYearInit)),
            endYearCustom = JSON.parse(JSON.stringify(endYearInit));
          for (
            var x = function x(t) {
                var i = a[l[t]];
                ...
                (o.wheelTo(s),
                  o.on("scrollEnd", function () {
                    ...
                    if (typeDateCurrent === "YYYY") {
                      var newListYearEl = handleInfiniteTime(
                        beginYearCustom,
                        endYearCustom,
                        n.getSelected(n.scroll["YYYY"]),
                      );
                      if (newListYearEl) {
                        S("#" + a.YYYY + " ul").innerHTML = newListYearEl.e;
                        beginYearCustom = newListYearEl.start;
                        endYearCustom = newListYearEl.finish;
                        n.scroll["YYYY"].selectedIndex = 100;
                        o.wheelTo("100");
                        n.scroll.YYYY.refresh();
                      }
                    }
                    var day = ""
                      .concat(n.getSelected(n.scroll["YYYY"]), "-")
                      .concat(n.getSelected(n.scroll["MM"]), "-")
                      .concat(
                        n.getSelected(n.scroll["DD"]),
                        ` ${
                          n.scroll["HH"] ? n.getSelected(n.scroll["HH"]) : "00"
                        }:${
                          n.scroll["mm"] ? n.getSelected(n.scroll["mm"]) : "00"
                        }`,
                      );
                    if (!handleValid(day)) {
                      document
                        .querySelector(".rolldate-confirm")
            ...
            x(T);
          setTimeout(function () {
            var panel = S(".rolldate-panel");
            if (panel) panel.className = "rolldate-panel fadeIn";
          }, 30);
        },
        tap: function (el, handler) {
          ...
          // remove old
          if (el._tapHandler) {
            el.removeEventListener("pointerup", el._tapHandler);
            el.removeEventListener("touchend", el._tapHandler);
            el.removeEventListener("click", el._tapHandler);
          }

          el._tapHandler = async (e) => {
            e.preventDefault?.();
            await handler.call(this, e);
          };

          if (window.PointerEvent) {
            el.addEventListener("pointerup", el._tapHandler, {
              passive: false,
            });
          } else if ("ontouchstart" in window) {
            el.addEventListener("touchend", el._tapHandler, { passive: false });
          } else {
        ...
        show: async function show() {
          ...
          if (t.el) {
            if (
              !(i = S(t.el)).closest(".vue3-ios-datepicker-container")
                .bindRolldate
            )
              return;
          ...
          S(".rolldate-container") ||
            ...
            (await this.createUI(), this.event());
          S(".rolldate-cancel").addEventListener("click", function () {
            _this2.hide(1);
          });
        },
          ...
          (a.tap(t, function () {
            ...
            a.tap(e, function () {
              var t = a.config,
                ...
                o = new Date();
              if (
                (validPast === null || validPast === void 0 ? void 0 : true) !==
                undefined
              ) {
                var day = ""
                  .concat(a.getSelected(a.scroll["YYYY"]), "-")
                  .concat(a.getSelected(a.scroll["MM"]), "-")
                  .concat(
                    a.getSelected(a.scroll["DD"]),
                    ` ${
                      a.scroll["HH"] ? a.getSelected(a.scroll["HH"]) : "00"
                    }:${a.scroll["mm"] ? a.getSelected(a.scroll["mm"]) : "00"}`,
                  );
                if (handleValid(day)) {
        ...
        getMonthlyDay: function getMonthlyDay(t, i) {
          var e = void 0;
          return (
        ...
        getSelected: function getSelected(t) {
          var _S$t$getSelectedIndex;
          return (_S$t$getSelectedIndex = S("#" + t.wrapper.id + " li", 1)[
            t.getSelectedIndex()
          ]) === null || _S$t$getSelectedIndex === void 0
            ? void 0
            : _S$t$getSelectedIndex.getAttribute("data-value");
        },
      }),
      (i.version = "3.1.3"),
      i
  ...
  return new Rolldate({
    el: elementAriaControls,
    format: format,
    title: title,
    value: value,
    beginYear: handleGetBeginYearAndEndYear(value || initValue, format)
      .beginYear,
    endYear: handleGetBeginYearAndEndYear(value || initValue, format).endYear,
    initValue: initValue,
  });
}

function handleGetBeginYearAndEndYear(propDate, format) {
  var valueGetDate = propDate
    ? dayjs(propDate, [format]).isValid()
      ? dayjs(propDate, [format]).toDate()
      : new Date()
    : new Date();
  var result = {
    beginYear: valueGetDate.getFullYear() - 100,
    endYear: valueGetDate.getFullYear() + 100,
  };
  return result;
}
